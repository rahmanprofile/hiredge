...
class CreateInternship extends StatefulWidget {
  const CreateInternship({Key? key}) : super(key: key);

  @override
  State<CreateInternship> createState() => _CreateInternshipState();
}

class _CreateInternshipState extends State<CreateInternship> {
  @override
  void initState() {
    __getUser();
    super.initState();
          ...
          child: SingleChildScrollView(
            ...
            child: Column(
              ...
              children: [
                ...
                Text(
                  "Create \nInternship for Seekers",
                  style: GoogleFonts.sansita(
                      fontSize: 25, fontWeight: FontWeight.w400),
                ),
                Text(
                  "Make Opportunity for new learner.",
                    ...
                    : RoundButton(
                        ...
                        onTap: () async {
                          if (_formKey.currentState!.validate()) {
                            _isLoading = true;
                            Provider.of<PostController>(context, listen: false).createInternship(context,
